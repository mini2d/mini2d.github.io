...
(function (mini2d) {
    var Sound = (function () {
        ...
        function Sound(game, path) {
            /**
             * A flag marking whether the sounds is playing or not
             */
            this.isPlaying = false;
            /**
             * A value in the range of 0-1 controlling the volume
             */
            this.volume = 1;
            this.game = game;
            this.path = path;
        ...
        /**
         * Plays the sound
         * @param offset The number of milliseconds which the sound playback should start from
         */
...
(function (mini2d) {
    ...
    var Body = (function () {
         ...
         * @param sprite The sprite on which this body is based
         */
        function Body(sprite) {
            /**
             * Number in the range of 0-1 reflecting how much the body bounces
             */
            this.restitution = 1;
            /**
            ...
            /**
             * Determines the directions from which to check for a world collision
             */
            this.checkWorldCollision = null;
            /**
             * Determines that an object should not be moved with upon collision
             */
        ...
        /**
         * Returns the X coordinate of the center of the body
         */
        Body.prototype.getMidX = function () {
            return this.halfWidth + this.position.x;
        };
        /**
         * Returns the Y coordinate of the center of the body
         */
        Body.prototype.getMidY = function () {
            return this.halfHeight + this.position.y;
        };
        /**
         * Returns the Y coordinate of the top of the body
         */
        Body.prototype.getTop = function () {
            return this.position.y;
        };
        /**
         * Returns the X coordinate of the left of the body
         */
        Body.prototype.getLeft = function () {
            return this.position.x;
        };
        /**
        * Returns the X coordinate of the right of the body
        */
        Body.prototype.getRight = function () {
            return this.position.x + this.width;
        };
        /**
         * Returns the Y coordinate of the bottom of the body
         */
        ...
        /**
         * Checks for collision with the other body and calls callback upon collision
         * @param body The other body to be checked for collision with
         * @param callback The function that gets called upon colliding with the body
         * @param resolveCollision Marks whether collision should be resolved with the physics engine
         */
        ...
        /**
         * Enables the collision with the world bound upon calling
         * @param callback The function that gets called when collision with world occurs, taking the first parameter a direction e.g. "left"
         */
...
(function (mini2d) {
    var CollisionDetector = (function () {
        /**
         * A constructor for the CollisionDetector class
         * param game A reference to the game instance
         */
         ...
         * param collided The first body
         * param collider The second body
         */
...
(function (mini2d) {
    var CollisionEngine = (function () {
        /**
         * A constructor for the CollisionEngine class
         * @param game The reference to the game instance
         * @param world The reference to the world instance
         */
        function CollisionEngine(game, world) {
            /**
             * A gravity constant, determines how bodies are pulled towards ground
             */
            this.gravity = 0;
            this.game = game;
            this.world = world;
        ...
        /**
         * A single step of the physics engine, called every frame
         * @param elapsed the delta time
         */
        CollisionEngine.prototype.step = function (elapsed) {
            var entities = this.world.sprites;
            for (var i = 0, length = entities.length; i < length; i++) {
                if (!this.world.sprites[i].body) {
                    continue;
                }
                var entity = entities[i].body;
                ...
                this.collisionSolver.resolveWorld(entity);
            }
        };
...
(function (mini2d) {
    var CollisionSolver = (function () {
        /**
         * The constructor for the CollisionSolver class
         * @param game The reference to the game instance
         */
        ...
        /**
         * Resolves the collision of the body with the world bounds
         * @param collider The body to be resolved from colliding with world bounds
         */
        ...
        /**
         * Repositions bodies so that they no longer collide
         * @param a The first body
         * @param b The second body
         * @param diff The length of the overlap between the two objects
         * @param axis The axis on which the reposition should happen
         */
        CollisionSolver.prototype.repositionBodies = function (a, b, diff, axis) {
            // based on which axis we are operating on, determine, which property to acess
            var property = (axis === "x") ? "width" : "height";
            if (a.immovable && !b.immovable) {
                b.position[axis] = a.position[axis] + a[property];
            }
            else if (!a.immovable && b.immovable) {
                a.position[axis] = b.position[axis] - a[property];
            }
            else {
                a.position[axis] = a.position[axis] - diff / 2;
                b.position[axis] = b.position[axis] + diff / 2;
            }
        };
...
(function (mini2d) {
    var StatePrefab = (function () {
        ...
        /**
         * Creates a game state based on this prefab and starts it
         */
